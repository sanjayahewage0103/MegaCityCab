...
<div class="container">
    ...
    <div class="left-container">
        ...
        <div class="vehicle-details animated delay-1" style="color: var(--dark-text); text-align: center; margin-top: 20px;">
            <h3 style="color: var(--primary); margin-bottom: 15px;">Our Vehicles</h3>
            <p>Quality, well-maintained vehicles are essential for providing exceptional service to our customers.</p>
            <div style="margin: 20px 0; text-align: left; padding-left: 20px;">
                <p><i class="fas fa-check" style="color: var(--primary); margin-right: 10px;"></i> Regularly serviced</p>
                <p><i class="fas fa-check" style="color: var(--primary); margin-right: 10px;"></i> Modern and comfortable</p>
                <p><i class="fas fa-check" style="color: var(--primary); margin-right: 10px;"></i> Various types available</p>
            </div>
        </div>
    </div>
    ...
    <div class="right-container">
        ...
        <!-- Form -->
        <form method="post" action="manage-vehicle" class="animated delay-2">
            ...
            <div class="form-container">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="registerNumber" name="registerNumber" class="form-control" placeholder="Enter registration number" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="color" name="color" class="form-control" placeholder="Enter vehicle color">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" id="seatingCapacity" name="seatingCapacity" class="form-control" placeholder="Enter seating capacity" required>
                    </div>
                </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Number validation for seating capacity
        const capacityInput = document.getElementById('seatingCapacity');
